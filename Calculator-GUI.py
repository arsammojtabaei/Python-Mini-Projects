...
subtraction = Button(window, padx=16, pady=16, bd=8, fg='black', font=('arial', 20, 'bold'),
...
multiply = Button(window, padx=16, pady=16, bd=8, fg='black', font=('arial', 20, 'bold'),
...
btnEquals = Button(window, padx=16, pady=16, bd=8, fg='black', font=('arial', 20, 'bold'),
